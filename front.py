...
EXE_PIPES_PAI   = (PROJECT_ROOT / "frontend" / "Pipes" / "Pipes_final" / "Pipes_Final_Pai"   / "Pipes_Final_Pai.exe").resolve()
EXE_PIPES_FILHO = (PROJECT_ROOT / "frontend" / "Pipes" / "Pipes_final" / "Pipes_Final_FIlho" / "Pipes_Final_FIlho.exe").resolve()
